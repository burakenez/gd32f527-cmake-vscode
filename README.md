[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32f527-cmake-vscode)](https://github.com/burakenez/gd32f527-cmake-vscode/tags/)

# GD32F527 Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32F527 Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32F527 Demo Suites V1.4.0](https://www.gd32mcu.com/en/download)_** and **_[GD32F527 Firmware Library V1.4.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
### 2. **CMSIS/GD/GD32F527**
- **Version:** `V1.4.0 (2026-01-31)`
- **Path:** `Drivers/CMSIS/GD/GD32F527`
- **Source:** `GD32F527 Demo Suites V1.4.0`

### 3. **GD32F527_standard_peripheral**
- **Version:** `V1.4.0 (2026-01-31)`
- **Path:** `Drivers/GD32F527_standard_peripheral`
- **Source:** `GD32F527 Demo Suites V1.4.0`

### 4. **GD32F527_usb_library**
- **Version:** `V1.4.0 (2026-02-06)`
- **Path:** `Drivers/GD32F527_usb_library`
- **Source:** `GD32F527 Demo Suites V1.4.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32f527_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32f527_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32f527_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32f527.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32f527.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32F527I_EVAL              # Board support package for GD32F527I_EVAL
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32F527
│           │   └── GD32F527_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32f527_flash.ld  # Linker script (memory regions)
│           └── GD32F527.svd             # SVD file for peripheral register views
